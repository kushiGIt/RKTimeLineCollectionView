...
@interface RKTransitionController()

@property (nonatomic) RKTransitionLayout* transitionLayout;
...
@implementation RKTransitionController
...
- (void)startInteractiveTransition:(id <UIViewControllerContextTransitioning>)transitionContext
{
    ...
    self.transitionLayout = (RKTransitionLayout *)[fromCollectionViewController.collectionView startInteractiveTransitionToCollectionViewLayout:toCollectionViewController.collectionViewLayout completion:^(BOOL didFinish, BOOL didComplete) {
...
- (void)oneFingerGesture:(UIPanGestureRecognizer *)sender
{
    ...
    else
    {
        ...
        if (isVerticalGesture) {
            ...
            distance = sqrt((point.x - [sender translationInView:sender.view].x) * (point.x - [sender translationInView:sender.view].x) + (point.y - [sender translationInView:sender.view].y) * (point.y - [sender translationInView:sender.view].y));
            
            // distance = sqrt(([sender translationInView:sender.view].x) * ([sender translationInView:sender.view].x) + ([sender translationInView:sender.view].y) * ([sender translationInView:sender.view].y));
